...
#    endif
#endif
#if($?ALTERA_QUARTUS_HOME && $?ALTERAOCLSDKROOT && $?AOCL_BOARD_PACKAGE_ROOT) then
#    source $MERLIN_COMPILER_HOME/set_env/set_altera.csh  2>/dev/null
#else
#    #printf "ALTERA_QUARTUS_HOME or ALTERAOCLSDKROOT or AOCL_BOARD_PACKAGE_ROOT not set!\n"
#    printf ""
#endif
